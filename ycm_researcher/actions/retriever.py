...
def get_retriever(retriever: str):
    ...
    match retriever:
        case "google":
            from ycm_researcher.retrievers import GoogleSearch

            return GoogleSearch
        case "searx":
            from ycm_researcher.retrievers import SearxSearch

            return SearxSearch
        case "searchapi":
            from ycm_researcher.retrievers import SearchApiSearch

            return SearchApiSearch
        case "serpapi":
            from ycm_researcher.retrievers import SerpApiSearch

            return SerpApiSearch
        case "serper":
            from ycm_researcher.retrievers import SerperSearch

            return SerperSearch
        case "duckduckgo":
            from ycm_researcher.retrievers import Duckduckgo

            return Duckduckgo
        case "bing":
            from ycm_researcher.retrievers import BingSearch

            return BingSearch
        case "arxiv":
            from ycm_researcher.retrievers import ArxivSearch

            return ArxivSearch
        case "tavily":
            from ycm_researcher.retrievers import TavilySearch

            return TavilySearch
        case "exa":
            from ycm_researcher.retrievers import ExaSearch

            return ExaSearch
        case "semantic_scholar":
            from ycm_researcher.retrievers import SemanticScholarSearch

            return SemanticScholarSearch
        case "pubmed_central":
            from ycm_researcher.retrievers import PubMedCentralSearch

            return PubMedCentralSearch
        case "custom":
            from ycm_researcher.retrievers import CustomRetriever
